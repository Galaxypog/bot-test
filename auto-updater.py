...
if "-dev" in sys.argv:
    githuburl = "https://raw.githubusercontent.com/renegadefn/renegadefn/Dev/"
else:
    githuburl = "https://raw.githubusercontent.com/renegadefn/renegadefn/master/"
...
if CheckUpdate("README_JA.md", githuburl):
    print("README_JA.mdの更新を確認しました。新機能の説明、内容の修正などがある可能性があるので確認してください")
    print("README_JA.md got updated. Descriptions for new systems, fixes are included. Please check\n")
...
if CheckUpdate("README_GE.md", githuburl):
    print("README_GE.mdの更新を確認しました。新機能の説明、内容の修正などがある可能性があるので確認してください")
    print("README_GE.md got updated. Descriptions for new systems, fixes are included. Please check\n")
